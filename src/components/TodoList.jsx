    ...
    <div className='w-full px-10'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
            ...
            {todosTodo.map((todo, key) => (
              <div className='bg-white p-5 rounded-md shadow-md border-l-4 mb-5 border-red-300' key={key}>
                <div className='flex flex-row'>
                  <p className='font-TTHovesProTrialDemiBold' onClick={() => openEditModal(todo.id)}>{todo.title}</p>
                  <ArrowCircleRightIcon className='ml-auto w-5' onClick={() => handleUpdate(todo.id)} />
                </div>
                <p className='font-TTHovesProTrialRegular mt-3'>{todo.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          <div className='p-5'>
            <div className='flex flex-col items-center justify-center'>
              <p className='font-TTHovesProTrialDemiBold text-lg'>Edit Your Task</p>
              <p className='font-TTHovesProTrialMedium text-sm p-3 text-gray-500'>Update your task details</p>
            </div>

            <form>
              <div className=''>
                <div className='w-full'>
                  <label htmlFor='title' className='text-formLable font-semibold mb-2'>
                    Title
                  </label>
                  <input
                    type='text'
